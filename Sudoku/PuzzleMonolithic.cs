...
namespace Sudoku
{
    ...
    /// </summary>
    /// <remarks>
    /// This class is the traditional POCO monolithic where everything is in one class.
    /// This class does not include a puzzle generator
    /// </remarks>
    /// <history>
    /// Date        Author                  Description
    /// 2019.09.01  Lehan, Ryan             Complete re-write from original
    /// </history>
    public class PuzzleMonolithic
    {
        #region Constants
